...
from app.core.types import Chunk, Evidence, EvidenceRating, LLMEvidence, RiskType
...
class EvidenceRepository:
    @staticmethod
    async def create_from_llm_evidence(
        llm_evidence: LLMEvidence, risk_type: RiskType, chunk: Chunk, evidence_ratings: list[EvidenceRating]
    ) -> Evidence:
        ...
        evidence_model = EvidenceModel(
            ...
            score=overall_score,
            metadata={"llm_confidence": llm_evidence.confidence},
        )
    ...
    @staticmethod
    async def get_by_id(evidence_id: str) -> Evidence | None:
        """Get evidence by ID."""
