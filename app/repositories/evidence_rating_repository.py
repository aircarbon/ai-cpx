...
class EvidenceRatingRepository:
    ...
    @staticmethod
    async def create_from_llm_rating(llm_rating: LLMDimensionRating, risk_type: RiskType, dimension_spec: RiskDimensionSpec) -> EvidenceRating:
    ...
    @staticmethod
    async def get_by_id(rating_id: str) -> Optional[EvidenceRating]:
