...
from app.core.types import Evidence, Project, RiskAssessment, RiskType


class RiskAssessmentRepository:
    @staticmethod
    async def create_risk_assessment(
        project: Project, risk_type: RiskType, evidences: list[Evidence], score: float | None
    ) -> RiskAssessment:
        ...
        risk_assessment_model = RiskAssessmentModel(
            project_id=project_model, risk_type_id=risk_type_model, evidence_ids=evidence_models, score=score
        )
    ...
    @staticmethod
    async def get_by_project_and_risk_type(project_id: str, risk_type_id: str) -> RiskAssessment | None:
        ...
        for model in all_models:
            ...
            if (
                model.project_id
                and model.risk_type_id
                and hasattr(model.project_id, "id")
                and hasattr(model.risk_type_id, "id")
                and str(model.project_id.id) == project_id
                and str(model.risk_type_id.id) == risk_type_id
            ):
    ...
    @staticmethod
    async def update_or_create_risk_assessment(
        project: Project, risk_type: RiskType, evidences: list[Evidence], score: float | None
    ) -> RiskAssessment:
    ...
    @staticmethod
    async def get_by_id(risk_assessment_id: str) -> RiskAssessment | None:
