...
from test_data_loader import (
    load_test_chunks,
    load_test_documents,
    load_test_evidence_ratings,
    load_test_evidences,
    load_test_project_score_summaries,
    load_test_project_scores,
    load_test_projects,
    load_test_risk_assessments,
)

from app.core.data_loader import initialize_configuration_data
from app.core.database import close_database, ensure_database_connection, get_database_status
...
def run_stages_up_to(target_stage):
    ...
    stages = [
        ...
        (
            "load-project-score-summaries",
            load_project_score_summaries,
            "📝 Stage 9: Loading test project score summaries...",
        ),
    ]
...
def main():
    parser = argparse.ArgumentParser(description="Test environment setup with multiple initialization stages")
    parser.add_argument(
        "stage",
